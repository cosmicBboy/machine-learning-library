...
for epoch = 1:epochs
  ...
  for m = 1:numbatches
    ...
    % BACK PROPAGATE.
    %% OUTPUT LAYER. This computes error derivatives with respect to the
    % weights between the output layer and the hidden layer.
    ...
    % option (b). This computes gradients for weights between the word
    % embedding layer and the hidden layer.
    ...
    % option (a). This computes the gradients of the bias weights between the
    ...
    % option (a). This computes the derivatives of error with respect to
    % weights between the word embedding layer and the hidden
