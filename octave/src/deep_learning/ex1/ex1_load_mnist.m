function [train, test] = ex1_load_mnist(binary_digits)
  ...
  X=loadMNISTImages('tmp/train-images-idx3-ubyte');
  y=loadMNISTLabels('tmp/train-labels-idx1-ubyte')';
  ...
  X=loadMNISTImages('tmp/t10k-images-idx3-ubyte');
  y=loadMNISTLabels('tmp/t10k-labels-idx1-ubyte')';
